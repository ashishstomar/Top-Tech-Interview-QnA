/*
📌 Problem:
Implement a function `rateLimiter(fn, limit)` that returns a new function
which allows calling `fn` only once every `limit` milliseconds.

-------------------------------------------------
🔹 Example:
const limitedLog = rateLimiter(console.log, 1000);
...
// ✅ Example Usage
const limitedLog = rateLimiter((msg) => console.log(msg, Date.now()), 1000);
